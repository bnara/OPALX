...
QP1: QUADRUPOLE, L=1.0, K1= 123.0, ;
QP2: QUADRUPOLE, L=1.0, K1=-4.567, Z = 1.0;
QP3: QUADRUPOLE, L=1.0, K1= 8.99, Z = 2.0;

S11: SEXTUPOLE, L=0.4, K2=0.00134, ELEMEDGE=4.000;

QUADTEST: LINE=(QP1,QP2,QP3);

D1: DISTRIBUTION, TYPE=GAUSS,SIGMAX=  5*1.0e-03,   SIGMAPX= 0.696*1.0e06,  CORRX= 0.0,SIGMAY=  5*1.0e-03,   SIGMAPY= 0.310*1.0e06,  CORRY= 0.0,OFFSETZ     =  0.005,        SIGMAT= 0.0005, SIGMAPT= 0.0, CORRT= 0.0, R61= 0.0, INPUTMOUNITS=EV;
