...
AMF1: SBEND, K0=0.804307, L=1.4929, Z = 39.0362, THETA = 349.220028 * PI / 180,
         E1= 10.779972 / 180 * PI, E2= 10.779972 / 180 * PI,        FMAPFN="HardEdge.T7",         DESIGNENERGY=7.381e+01, GAP=.2;

D84: DRIFT, L=0.395, X = -0.7109069987, Z = 40.3522060646, THETA = 303.361656 * PI / 180;
MMFP3X: MONITOR, OUTFN="MMFP3X.h5", X = -1.0366412689, Z = 40.5666756084, THETA = 303.361656 * PI / 180;
MMFP4Y: MONITOR, OUTFN="MMFP4Y.h5", X = -1.0366412689, Z = 40.5666756084, THETA = 303.361656 * PI / 180;
D86: DRIFT, L=0.2667, X = -1.0408173493, Z = 40.5694252179, THETA = 303.361656 * PI / 180;
QMF3: QUADRUPOLE, K1=-4.21226, L=0.32, X = -1.2635694772, Z = 40.7160893905, THETA = 303.361656 * PI / 180;

SMF2: DRIFT, L=0.17, X = -1.5308386220, Z = 40.8920644008, THETA = 303.361656 * PI / 180;
D87: DRIFT, L=0.17, X = -1.6728253552, Z = 40.9855511250, THETA = 303.361656 * PI / 180;
QMF4: QUADRUPOLE, K1=5.77077, L=0.32, X = -1.8148120884, Z = 41.0790378492, THETA = 303.361656 * PI / 180;

D88: DRIFT, L=0.425, X = -2.0820812332, Z = 41.2550128594, THETA = 303.361656 * PI / 180;

AMF2: SBEND, 		 K0=-0.804017, L=1.4929, 		 X = -2.4370480661, Z = 41.4887296699, THETA = 314.141627 * PI / 180, PSI = 180.0 * PI / 180,
         E1= 10.779972 / 180 * PI, E2= 10.779972 / 180 * PI,        FMAPFN="HardEdge.T7", 
         DESIGNENERGY=7.381e+01, GAP=.1;

D89: DRIFT, L=0.395, X = -3.1458601497, Z = 43.7052747653, THETA = 359.977736 * PI / 180;
MMFP5X: MONITOR, OUTFN="MMFP5X.h5", X = -3.1460116931, Z = 44.0952747359, THETA = 359.977736 * PI / 180;
MMFP6Y: MONITOR, OUTFN="MMFP6Y.h5", X = -3.1460116931, Z = 44.0952747359, THETA = 359.977736 * PI / 180;
SMF3: DRIFT, L=0.3446, X = -3.1460136360, Z = 44.1002747355, THETA = 359.977736 * PI / 180;
D92: DRIFT, L=0.1269, X = -3.1461475382, Z = 44.4448747095, THETA = 359.977736 * PI / 180;
QMF5: QUADRUPOLE, K1=0.0590979, L=0.32, X = -3.146196848, Z = 44.5717746999, THETA = 359.977736 * PI / 180;

D93: DRIFT, L=0.14, X = -3.1463211914, Z = 44.8917746757, THETA = 359.977736 * PI / 180;
QMF6: QUADRUPOLE, K1=6.0462, L=0.32, X = -3.1463755916, Z = 45.0317746652, THETA = 359.977736 * PI / 180;

D94: DRIFT, L=0.14, X = -3.1464999349, Z = 45.351774641, THETA = 359.977736 * PI / 180;
QMF7: QUADRUPOLE, K1=-4.66959, L=0.32, X = -3.146554335, Z = 45.4917746304, THETA = 359.977736 * PI / 180;

D95: DRIFT, L=0.264, X = -3.1466786784, Z = 45.8117746063, THETA = 359.977736 * PI / 180;
WMFT: DRIFT, L=0.2, X = -3.1467812616, Z = 46.0757745863, THETA = 359.977736 * PI / 180;
D96: DRIFT, L=0.18, X = -3.1468589762, Z = 46.2757745712, THETA = 359.977736 * PI / 180;
WMFU: DRIFT, L=0.34, X = -3.1469289193, Z = 46.4557745577, THETA = 359.977736 * PI / 180;
D97: DRIFT, L=0.5473, X = -3.147061034, Z = 46.7957745320, THETA = 359.977736 * PI / 180;
AMF3: SBEND, K0=-0.811531, L=2.17747, X = -3.1472736999, Z = 47.3430744907, THETA = 11.877726 * PI / 180, PSI = 180.0 * PI / 180,
         E1= 11.899990 / 180 * PI, E2= 23.000016 / 180 * PI,        FMAPFN="HardEdge.T7",
         DESIGNENERGY=7.381e+01, GAP=75*2/1000;

D98ext: DRIFT, L=0.373420, X = 0.7118721544, Z = 48.9626615202, THETA = 88.531390 * PI / 180;
 
Mon_D98extX: MONITOR, OUTFN="Mon_D98extX.h5", X = 1.0801711344, Z = 48.9721038575, THETA = 88.531390 * PI / 180;
Mon_D98extY: MONITOR, OUTFN="Mon_D98extX.h5", X = 1.0801711344, Z = 48.9721038575, THETA = 88.531390 * PI / 180;
...
Drift_isoa: Drift, L=0.150, ELEMEDGE= 51.006980+Len_air+total_Mylaar_thick;
 Mon_ISO: MONITOR, X = 2.5954702196, Z = 49.0109526346, THETA = 88.531390 * PI / 180,  OUTFN="Mon_ISO.h5";
