...
AMF2: SBEND, 		 K0=0.804017, L=1.4929, 		 X = -2.4370480688, Z = 41.4887296717, THETA = 303.361656 * PI / 180,
        FMAPFN="HardEdge.T7", 
         DESIGNENERGY=7.381e+01, GAP=.1;

D89: DRIFT, L=0.395, X = -3.9271056206, Z = 41.6189637349, THETA = 246.745575 * PI / 180;
MMFP5X: MONITOR, OUTFN="MMFP5X.h5", X = -4.2854223014, Z = 41.4649859564, THETA = 246.745575 * PI / 180;
MMFP6Y: MONITOR, OUTFN="MMFP6Y.h5", X = -4.2854223014, Z = 41.4649859564, THETA = 246.745575 * PI / 180;
SMF3: DRIFT, L=0.3446, X = -4.2900161050, Z = 41.4630118824, THETA = 246.745575 * PI / 180;
D92: DRIFT, L=0.1269, X = -4.606621049, Z = 41.3269586965, THETA = 246.745575 * PI / 180;
QMF5: QUADRUPOLE, K1=0.0590979, L=0.32, X = -4.7232117844, Z = 41.2768566963, THETA = 246.745575 * PI / 180;

D93: DRIFT, L=0.14, X = -5.0172152148, Z = 41.1505159550, THETA = 246.745575 * PI / 180;
QMF6: QUADRUPOLE, K1=6.0462, L=0.32, X = -5.1458417156, Z = 41.0952418806, THETA = 246.745575 * PI / 180;

D94: DRIFT, L=0.14, X = -5.4398451460, Z = 40.9689011393, THETA = 246.745575 * PI / 180;
QMF7: QUADRUPOLE, K1=-4.66959, L=0.32, X = -5.5684716468, Z = 40.9136270650, THETA = 246.745575 * PI / 180;

D95: DRIFT, L=0.264, X = -5.8624750772, Z = 40.7872863236, THETA = 246.745575 * PI / 180;
WMFT: DRIFT, L=0.2, X = -6.1050279072, Z = 40.683055212, THETA = 246.745575 * PI / 180;
D96: DRIFT, L=0.18, X = -6.2887800512, Z = 40.6040922487, THETA = 246.745575 * PI / 180;
WMFU: DRIFT, L=0.34, X = -6.4541569808, Z = 40.5330255817, THETA = 246.745575 * PI / 180;
D97: DRIFT, L=0.5473, X = -6.7665356256, Z = 40.398788544, THETA = 246.745575 * PI / 180;
AMF3: SBEND, K0=-0.811531, L=2.17747, X = -7.2693733677, Z = 40.1827063949, THETA = 246.745575 * PI / 180, PSI = 180.0 * PI / 180,
        FMAPFN="HardEdge.T7",
         DESIGNENERGY=7.381e+01, GAP=75*2/1000;

D98ext: DRIFT, L=0.373420, X = -10.5758849219, Z = 43.7335552458, THETA = 335.299228 * PI / 180;
 
Mon_D98extX: MONITOR, OUTFN="Mon_D98extX.h5", X = -10.7298400170, Z = 44.0682657552, THETA = 335.299228 * PI / 180;
Mon_D98extY: MONITOR, OUTFN="Mon_D98extX.h5", X = -10.7298400170, Z = 44.0682657552, THETA = 335.299228 * PI / 180;
...
Drift_isoa: Drift, L=0.150, ELEMEDGE= 51.006980+Len_air+total_Mylaar_thick;
 Mon_ISO: MONITOR, X = -11.36326022, Z = 45.4453711947, THETA = 335.299228 * PI / 180,  OUTFN="Mon_ISO.h5";
