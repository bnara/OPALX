...
%Editing Macros
\newcommand{\TODO}[1]{\ifthenelse{\boolean{ShowDebug}}{\color{red}TODO: #1}{}}

%text in gray box
\newsavebox{\fmbox}
\definecolor{lightgray}{gray}{0.95}
\newenvironment{fmpage}
   {\begin{lrbox}{\fmbox}\begin{minipage}[ht]{13.5cm}}
   {\end{minipage}\end{lrbox}\begin{center}\fcolorbox{black}{lightgray}{\usebox{\fmbox}}\end{center}}
...
\newcommand{\latermore}{More details will be given in Version 2.0.0}
...
%% keyword not allowed in PDFDocEncoded string
\newcommand{\keywordinheader}[1]{\texorpdfstring{\keyword{#1}}{#1}}
...
%% renew as filename command might already be defined
\makeatletter
