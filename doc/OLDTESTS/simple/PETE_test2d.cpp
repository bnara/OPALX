...
int main(int argc, char *argv[]) {
  ...
  assign( mask[I][J], lt(I+J,centerX) );
  const double fact1 = 1.0/6.0;
  const double fact2 = 1.0/8.0;

  assign( B[I][J], where( mask[I][J],
                          fact1 * (A[I][J] + A[I][J] + A[I][J+1] +
                                   A[I][J-1] + A[I+1][J] + A[I-1][J]),
                          fact2 * (A[I+1][J+1] + A[I-1][J+1] + A[I+1][J-1] +
...
/***************************************************************************
 * $RCSfile: PETE_test2d.cpp,v $   $Author: adelmann $
 * $Revision: 1.1.1.1 $   $Date: 2000/11/30 21:04:14 $
 * IPPL_VERSION_ID: $Id: PETE_test2d.cpp,v 1.1.1.1 2000/11/30 21:04:14 adelmann Exp $
 ***************************************************************************/
