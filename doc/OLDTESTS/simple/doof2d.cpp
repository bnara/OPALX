...
int main(int argc, char *argv[])
{
  ...
  FieldBlock<double,Dim> io("atest",layout,2);
...
/***************************************************************************
 * $RCSfile: doof2d.cpp,v $   $Author: adelmann $
 * $Revision: 1.1.1.1 $   $Date: 2000/11/30 21:05:46 $
 * IPPL_VERSION_ID: $Id: doof2d.cpp,v 1.1.1.1 2000/11/30 21:05:46 adelmann Exp $ 
 ***************************************************************************/
