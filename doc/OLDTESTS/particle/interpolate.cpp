...
class SpecialParticle : public GenArrayParticle<PLayout,T,N> {
...
public:
  ...
  SpecialParticle(PLayout* L) : GenArrayParticle<PLayout,T,N>(L) {
 ...
 * $Revision: 1.1.1.1 $   $Date: 2000/11/30 21:02:39 $
 * IPPL_VERSION_ID: $Id: interpolate.cpp,v 1.1.1.1 2000/11/30 21:02:39 adelmann Exp $ 
 ***************************************************************************/
