...
ostream& operator<<(ostream&, const FieldLayout<Dim>&);

// ada: BrickInfo class BrickInfo;
...
// ada: BrickInfo  void initialize(const NDIndex<Dim>& domain, BrickInfo *bi, se_dim_tag *p=0, int vnodes=-1);
...
// ada: BrickInfo  void setup(const NDIndex<Dim>&, BrickInfo *bi, e_dim_tag *, int);
			      ...
			      bool recurse, int vnodes)
{
  ...
  // Verify than total vnodes is product of per-dimension vnode counts:
  if (vnodes != vnodes1*vnodes2*vnodes3) {
    ERRORMSG("FieldLayout constructor: "
			      ...
			      bool recurse, int vnodes)
{
  ...
  // Verify than total vnodes is product of per-dimension vnode counts:
  if (vnodes != vnodes1*vnodes2*vnodes3*vnodes4) {
    ERRORMSG("FieldLayout constructor: "
			      ...
			      bool recurse, int vnodes)
{
  ...
  // Verify than total vnodes is product of per-dimension vnode counts:
  if (vnodes != vnodes1*vnodes2*vnodes3*vnodes4*vnodes5) {
    ERRORMSG("FieldLayout constructor: "
			      ...
			      bool recurse, int vnodes)
{
  ...
  // Verify than total vnodes is product of per-dimension vnode counts:
  if (vnodes != vnodes1*vnodes2*vnodes3*vnodes4*vnodes5*vnodes6) {
    ERRORMSG("FieldLayout constructor: "
...
template<unsigned Dim>
inline
ostream& operator<<(ostream& out, const FieldLayout<Dim>& f) {
