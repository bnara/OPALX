...
BeamBeamWindowAnimation::BeamBeamWindowAnimation(
...
void BeamBeamWindowAnimation::render(
    ...
    std::vector<std::string> lines{
        renderMeshEnvelope(
            meshBeginS, meshEndS, beamBeamWindowBeginS, beamBeamWindowEndS),
        renderCenters(
...
std::pair<double, double> BeamBeamWindowAnimation::getDisplayRange(
    ...
    const double beamBeamWindowLength =
        beamBeamWindowEndS - beamBeamWindowBeginS;
...
void BeamBeamWindowAnimation::placeMarker(
...
std::string BeamBeamWindowAnimation::renderCenters(
    ...
    const std::size_t startIdx =
        mapToDisplayIndex(beamBeamWindowBeginS, displayMinS, displayMaxS);
    const std::size_t endIdx =
        mapToDisplayIndex(beamBeamWindowEndS, displayMinS, displayMaxS);
