...
bool ParallelCyclotronTracker::getFieldsAtPoint(const double& t, const size_t& Pindex, Vector_t<double, 3>& Efield, Vector_t<double, 3>& Bfield) {
...
bool ParallelCyclotronTracker::checkGapCross(Vector_t<double, 3> Rold, Vector_t<double, 3> Rnew,
...
void ParallelCyclotronTracker::globalToLocal(ParticleAttrib<Vector_t<double, 3>>& particleVectors,
                                             double phi, Vector_t<double, 3> const translationToGlobal) {
...
void ParallelCyclotronTracker::localToGlobal(ParticleAttrib<Vector_t<double, 3>>& particleVectors,
                                             double phi, Vector_t<double, 3> const translationToGlobal) {
    IpplTimings::startTimer(TransformTimer_m);
...
inline void ParallelCyclotronTracker::globalToLocal(ParticleAttrib<Vector_t<double, 3>>& particleVectors,
...
inline void ParallelCyclotronTracker::localToGlobal(ParticleAttrib<Vector_t<double, 3>>& particleVectors,
                                                    Quaternion_t const quaternion,
                                                    Vector_t<double, 3> const meanR) {
    IpplTimings::startTimer(TransformTimer_m);
...
inline void ParallelCyclotronTracker::globalToLocal(Vector_t<double, 3>& myVector,
                                                    double const phi,
                                                    double const psi,
                                                    Vector_t<double, 3> const meanR) {
...
inline void ParallelCyclotronTracker::localToGlobal(Vector_t<double, 3>& myVector,
                                                    double const phi,
                                                    double const psi,
                                                    Vector_t<double, 3> const meanR) {
...
inline void ParallelCyclotronTracker::rotateWithQuaternion(ParticleAttrib<Vector_t<double, 3>>& particleVectors, Quaternion_t const quaternion) {

    Vector_t<double, 3> const quaternionVectorComponent = Vector_t<double, 3>(quaternion(1), quaternion(2), quaternion(3));
...
inline void ParallelCyclotronTracker::rotateAroundZ(ParticleAttrib<Vector_t<double, 3>>& particleVectors, double const phi) {
...
inline void ParallelCyclotronTracker::rotateAroundZ(Vector_t<double, 3>& myVector, double const phi) {
...
inline void ParallelCyclotronTracker::rotateAroundX(ParticleAttrib<Vector_t<double, 3>>& particleVectors, double const psi) {
...
inline void ParallelCyclotronTracker::rotateAroundX(Vector_t<double, 3>& myVector, double const psi) {
...
inline void ParallelCyclotronTracker::getQuaternionTwoVectors(Vector_t<double, 3> u, Vector_t<double, 3> v, Quaternion_t& quaternion) {
...
bool ParallelCyclotronTracker::deleteParticle(bool flagNeedUpdate) {
    ...
    if (flagNeedUpdate) {
        ...
        globalToLocal(itsBunch_m->P, phi, psi, Vector_t<double, 3>(0.0)); // P should be rotated, but not shifted
...
void ParallelCyclotronTracker::initDistInGlobalFrame() {
    ...
    if (!OpalData::getInstance()->inRestartRun()) {
        ...
        Vector_t<double, 3> const initMeanR = Vector_t<double, 3>(Units::mm2m * referenceR * cosRefTheta_m,
...
bool ParallelCyclotronTracker::computeExternalFields_m(const Vector_t<double, 3>& R, const Vector_t<double, 3>& P, const double& t,
                                                       Vector_t<double, 3>& Efield, Vector_t<double, 3>& Bfield) {
