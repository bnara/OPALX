...
bool FM1DMagnetoStatic::getFieldstrength(const Vector_t<double, 3> &R, Vector_t<double, 3> &E,
...
bool FM1DMagnetoStatic::getFieldDerivative(const Vector_t<double, 3> &R,
        Vector_t<double, 3> &/*E*/,
        Vector_t<double, 3> &B,
...
void FM1DMagnetoStatic::computeFieldOffAxis(const Vector_t<double, 3> &R,
                                            Vector_t<double, 3> &/*E*/,
        Vector_t<double, 3> &B,
