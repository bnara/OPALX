...
inline
bool FM3DMagnetoStatic::isInside(const Vector_t<double, 3> &r) const
{
...
inline
FM3DMagnetoStatic::IndexTriplet FM3DMagnetoStatic::getIndex(const Vector_t<double, 3> &X) const {
    IndexTriplet idx;
