...
Astra1DDynamic_fast::Astra1DDynamic_fast(std::string aFilename) : Astra1D_fast(aFilename) {
    numHeaderLines_m = 3;
...
bool Astra1DDynamic_fast::getFieldstrength(
...
bool Astra1DDynamic_fast::getFieldDerivative(
...
void Astra1DDynamic_fast::getFieldDimensions(
