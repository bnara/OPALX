...
#ifdef HAVE_AMR_MG_SOLVER
        c = getopt_long(argc, argv, "x:y:z:l:m:r:i:b:n:whcvpst:f:a:g:q:o:", long_options, &option_index);
#else
        c = getopt_long(argc, argv, "x:y:z:l:m:r:i:b:n:whcvpst:f:", long_options, &option_index);
#endif
