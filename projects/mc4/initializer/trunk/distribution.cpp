                         ...
                         distribution_t *d)
{
    if (USE_SLAB_WORKAROUND) {
        redistribute_slab(a, b, d, REDISTRIBUTE_1_TO_3, comm);
    } else {
        redistribute(a, b, d, REDISTRIBUTE_1_TO_3, comm);
    }
}
...
{
    if (USE_SLAB_WORKAROUND) {
        redistribute_slab(a, b, d, REDISTRIBUTE_3_TO_1, comm);
    } else {
        redistribute(a, b, d, REDISTRIBUTE_3_TO_1, comm);
    }
}
