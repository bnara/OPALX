...
public:
    ...
    typedef typename ChargedParticles<T,Dim>::RxField_t RxField_t;
    ...
    virtual void CICforward(ChargedParticles<T,Dim> *beam) = 0;
    virtual void calcPwrSpecAndSave(ChargedParticles<T,Dim> *univ, std::string fn)  = 0;
