...
#ifdef POOMA_USE_SINGLE_PRECISION
typedef float                                       DTYPE;
#else
...
int main(int argc, char *argv[]) {
  ...
  for (i=0; i < iters; ++i) {
    ...
    PoomaCounter ca("RC Forward Transform");
    ca.startCounter();
    ...
    PoomaCounter cb("RC Reverse Transform");
    cb.startCounter();
...
/***************************************************************************
 * $RCSfile: fftspeed.cpp,v $   $Author: bfh $
 * $Revision: 1.4 $   $Date: 1998/12/23 00:11:45 $
 * POOMA_VERSION_ID: $Id: fftspeed.cpp,v 1.4 1998/12/23 00:11:45 bfh Exp $ 
 ***************************************************************************/
